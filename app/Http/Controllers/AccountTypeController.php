...
class AccountTypeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $input = $request->only(['account_type','name', 'parent_account_type_id','the_type']);
    ...
    public function createSub($parent_id)         //create child
    {
        if (!auth()->user()->can('account.access')) {
            abort(403, 'Unauthorized action.');
        }
       ...
       ->get();
        ...
        return view('account_types.createSub')
                ->with(compact('account_types'));
    }
    ...
    public function edit($id)
    {
        ...
        $account_types = AccountType::where('business_id', $business_id)->where('id', $account_type->parent_account_type_id)
                                     ->get();
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $input = $request->only(['account_type','name','the_type']);
