...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
    ...
    Route::get('account_types/createSub/{parent_id}', 'AccountTypeController@createSub')->name('account_types.createSub');

    Route::post('account-types/storeSub', [AccountTypeController::class, 'storeSub'])
    ->name('account-types.storeSub');


    //costCenter 
    // Index - Read all cost centers
Route::get('/costcenters', [CostCenterController::class, 'index'])->name('costcenter.index');

// Show - Read a specific cost center
Route::get('/costcenters/show/{id}', 'CostCenterController@show')->name('costcenter.show');


// Create - Show the form to create a new cost center
Route::get('/costcenters/create', [CostCenterController::class, 'create'])->name('costcenter.create');
...
// Edit - Show the form to edit a specific cost center
Route::get('/costcenters/edit/{id}', [CostCenterController::class, 'edit'])->name('costcenter.edit');

// Update - Update a specific cost center in the database
Route::put('/costcenters/{id}', [CostCenterController::class, 'update'])->name('costcenter.update');

// Destroy - Delete a specific cost center from the database
Route::delete('/costcenters/{id}', [CostCenterController::class, 'destroy'])->name('costcenter.destroy');
Route::get('/costcenters/createSub/{main_center_id}', [CostCenterController::class, 'createSub'])->name('costcenter.createSub');

Route::post('/costcenters/storeSub',[CostCenterController::class, 'storeSub'])
->name('account-types.storeSub');
...
Route::get('/journal_entries', [JournalEntriesController::class, 'index']);
Route::get('/journal_entries/create', [JournalEntriesController::class, 'create']);
Route::post('/journal_entries', [JournalEntriesController::class, 'store']);
Route::get('/journal_entries/{id}', [JournalEntriesController::class, 'show']);
Route::get('/journal_entries/edit/{id}', [JournalEntriesController::class, 'edit']);
Route::put('/journal_entries/{id}', [JournalEntriesController::class, 'update']);
Route::delete('/journal_entries/{id}', [JournalEntriesController::class, 'destroy']);
